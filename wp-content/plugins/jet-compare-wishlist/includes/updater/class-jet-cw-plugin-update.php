...
require jet_cw()->plugin_path( 'includes/updater/class-jet-cw-base-update.php' );
 ...
 * @since 1.0.0
 */
class Jet_CW_Plugin_Update extends Jet_CW_Base_Update {
...
if ( ! function_exists( 'jet_cw_updater' ) ) {
	function jet_cw_updater() {
		return new Jet_CW_Plugin_Update();
	}
}
