...
if ( ! class_exists( 'Jet_CW_Compare_Integration' ) ) {
	...
	class Jet_CW_Compare_Integration {
		...
		public function __construct() {
			...
			if( jet_cw()->settings->get( 'add_default_compare_button' ) ){
		...
		public function register_compare_button_content_controls( $obj, $args = array() ){
		...
		public function register_compare_button_style_controls( $obj, $args = array() ){
		...
		public function register_compare_button_show_control( $obj, $args = array() ){
			$obj->add_control(
				'show_compare',
				array(
